        ...
        <>
            <Navbar id='footer' className='row pt-0 pb-0 mx-auto' collapseOnSelect fixed='bottom' expand="lg"  height='50px'>
                <Navbar.Brand className='mx-auto pt-0 pb-0 text-center mt-0 mb-0'>
                    ...
                    <span id='logos' className=' no3 text-center m-0' onClick={() => window.open("https://www.yelp.com/biz/mandeep-stylist-san-francisco-3", "_blank")}><i className="ml-5 mr-3 fab fa-yelp"></i></span>
                </Navbar.Brand>
            </Navbar>
        </>
    )
