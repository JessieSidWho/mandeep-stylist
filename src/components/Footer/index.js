...
const Footer = () => {
    return (
        <>
            <Navbar id='footer' className='row mx-auto' collapseOnSelect fixed='bottom' expand="lg" bg="secondary" variant="" height='50px'>
                <Navbar.Brand className='mx-auto text-center mt-0 mb-0'>
